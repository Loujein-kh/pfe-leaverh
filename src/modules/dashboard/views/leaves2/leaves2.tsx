...
const onSearch = (value: string) => {
    ...
    },
 {
      ...
      render: (_, { tags }) => (
        <>
          {tags.map((tag) => {
            let color = tag.length > 5 ? 'geekblue' : 'pink';
            if (tag === 'vacation') {
              color = 'green';
            }
            return (
  ...
  const data = [
    {
      key: '1',
      name: 'Billy Strosin',
      sdate: '10/02/2025  22:15',
      edate: '15/02/2025  22:15',
      duration:'5 days',
      tags: ['vacation'],
      status: ['pending'],
    ...
    },
    {
      key: '2',
      name: 'Jim Bocker',
      sdate: '24/03/2025  8:15',
      edate: '01/04/2025  8:15',
      duration:'5 days',
      tags: ['vacation'],
      status: ['pending'],
    },
    {
      key: '3',
      name: 'Joe Wolf',
      sdate: '17/04/2025  8:02',
      edate: '17/05/2025  8:02',
      duration:'30 days',
      tags: ['vacation'],
      status: ['pending'],
    },
    {
      key: '4',
      name: 'Amelie Runte',
      sdate: '20/04/2025  12:00',
      edate: '20/05/2025  12:00',
      duration:'30 days',
      tags: ['vacation'],
      status: ['pending'],
    },
    ...
    <div className="flex min-h-screen">
      ...
      <aside className="w-[15%] bg-gray-100 border-r border-gray-300 p-5">
        ...
        <nav className="space-y-8 text-gray-700">
          ...
          <Link to="/leaves2" className="flex items-center gap-2 text-purple-700 font-medium text-2xl hover:text-purple-700">
  ...
  />
        ...
        {/* Job Overview */}
        <div>
          <h2 className="text-3xl font-semibold mt-10">Latest Leaves Request</h2>
          <p className="text-gray-400 text-2xl mb-8 mb-2">Keep Lorem IpsumLorem IpsumLorem.</p>
        </div>
